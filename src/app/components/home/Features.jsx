...
export default () => (
  ...
  >
    <EntryAnimation animation="fade up">
      <div id="features">
        <Feature header="Security" image="/assets/images/security.png">
          Security is our priority. We employ an agressive cold storage policy
          on all currencies in our system.
        </Feature>
        ...
        <Feature header="Asset Trading" image="/assets/images/charts.png">
          We are providing some unique real time trading opportunities apart
          from currencies, more infomation coming soon.
        </Feature>
        <Feature header="Support" image="/assets/images/support.png">
          We believe good support is second only to security and endevour to
          answer your queries as quickly as possible.
        </Feature>
      </div>
    </EntryAnimation>
  </Segment>
